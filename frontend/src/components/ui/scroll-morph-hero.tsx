...
export default function IntroAnimation({ onGetStarted }: IntroAnimationProps) {
            ...
            <div className="flex h-full w-full flex-col items-center justify-center" style={{ perspective: "1000px" }}>
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-gray-600 max-w-lg leading-relaxed">
                        Detect blur, fix exposure, group similar shots, and automatically <br className="hidden md:block" />
                        select your best photos — all in one click.
                    </p>

                    {/* CTA Button */}
                    <motion.div
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: morphValue > 0.9 ? 1 : 0, y: morphValue > 0.9 ? 0 : 10 }}
                        transition={{ duration: 0.5, delay: 0.2 }}
                        className="mt-8 pointer-events-auto"
                    >
                        <button
                            onClick={onGetStarted}
                            className="group relative inline-flex items-center gap-2.5 px-8 py-3.5 bg-gray-900 text-white text-sm font-semibold rounded-full shadow-lg shadow-gray-900/20 hover:bg-gray-800 hover:shadow-xl hover:shadow-gray-900/25 transition-all duration-300"
                        >
                            Get Started
